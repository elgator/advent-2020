...
# ╔═╡ 7b53f280-355a-11eb-1a08-634a30742d67
function all_slopes()
	trees = 1
	trees *= count_trees(1, 1)
	trees *= count_trees(1, 3)
	trees *= count_trees(1, 5)
	trees *= count_trees(1, 7)
	trees *= count_trees(2, 1)
	return trees
end

# ╔═╡ e0dfe370-355a-11eb-36b0-c3fca9540c40
all_slopes()
